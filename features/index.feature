...
Background:
  Given the following restaurants exist
    | name                | street            | email               | phone         | state           | city        | country |
    | Goteborg Wok Sushi  | Östrahamngatan 5  | goteborgwok@live.se | 031-13 51 52  | Västra Götaland | Gothenbourg | Sweden  |
...
Scenario:
  ...
  And I should see "state: Västra Götaland"
